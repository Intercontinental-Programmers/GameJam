...
export default class extends Phaser.State {
  ...
  preload() {
    ...
    game.load.spritesheet('mission1_locked_button', 'assets/buttons/mission1_locked.png', 153, 167);
    game.load.spritesheet('mission2_locked_button', 'assets/buttons/mission2_locked.png', 153, 167);
  ...
  create() {
    ...
    this.missionButton_state.set(this.mission1_button, {state: "completed", image: 'mission-completed_button'});
    this.missionButton_state.set(this.mission2_button, {state: "unlocked", image: 'mission2_button'});
